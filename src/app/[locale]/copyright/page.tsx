...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Indiana Jones and the Great Circle Wiki',
    description: 'Copyright and intellectual property information for Indiana Jones and the Great Circle Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Indiana Jones and the Great Circle Wiki',
      description: 'Copyright and intellectual property information for Indiana Jones and the Great Circle Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Indiana Jones and the Great Circle Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Indiana Jones and the Great Circle Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Indiana Jones and the Great Circle Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Indiana Jones and the Great Circle Developers</strong> - Creators of the Indiana Jones and the Great Circle game</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>INDIANA JONES AND THE GREAT CIRCLE</strong> - Trademark and related rights of Lucasfilm Ltd. and used under license</li>
              <li><strong>Indiana Jones and the Great Circle</strong> - Trademark of the game developers</li>
              <li><strong>Indiana Jones and the Great Circle Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Indiana Jones and the Great Circle Wiki.
            </p>
            ...
            <p>
              ...
              Indiana Jones and the Great Circle Wiki<br />
              Email: <a href="mailto:dmca@indianajonesandthegreatcircle.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@indianajonesandthegreatcircle.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Indiana Jones and the Great Circle Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Indiana Jones and the Great Circle Wiki (indianajonesandthegreatcircle.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@indianajonesandthegreatcircle.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@indianajonesandthegreatcircle.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@indianajonesandthegreatcircle.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@indianajonesandthegreatcircle.wiki</a>
            </p>
            <p>
