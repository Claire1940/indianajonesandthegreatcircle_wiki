...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Indiana Jones and the Great Circle Wiki",
    description: "Read the Terms of Service for Indiana Jones and the Great Circle Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Steam game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Indiana Jones and the Great Circle Wiki",
      description: "Terms and conditions for using Indiana Jones and the Great Circle Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Indiana Jones and the Great Circle Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Indiana Jones and the Great Circle Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Indiana Jones and the Great Circle Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Indiana Jones and the Great Circle Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the action-adventure game "Indiana Jones and the Great Circle". Our services include, but are not limited to:
            </p>
            <ul>
            ...
            <p>
              <strong>Important:</strong> Indiana Jones and the Great Circle Wiki is NOT affiliated with, endorsed by, or associated with
              Bethesda Softworks, Lucasfilm Games, or MachineGames. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Indiana Jones and the Great Circle Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Bethesda Softworks, Lucasfilm Games, and MachineGames. We use such
            ...
            <p>
              ...
              you and Indiana Jones and the Great Circle Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@indianajonesandthegreatcircle.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@indianajonesandthegreatcircle.wiki</a>
            </p>
            <p>
