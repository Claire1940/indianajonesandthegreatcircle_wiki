...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.indianajonesandthegreatcircle.wiki'
  const path = '/about'

  return {
    title: 'About Indiana Jones and the Great Circle Wiki - Your Ultimate Steam Game Resource',
    description: 'Learn about Indiana Jones and the Great Circle Wiki, a community-driven resource hub providing comprehensive guides, crafting tips, creature info, and strategies for the Indiana Jones and the Great Circle Steam game.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: 'Indiana Jones and the Great Circle Wiki',
      title: 'About Indiana Jones and the Great Circle Wiki',
      description: 'Learn about our mission to provide the best Indiana Jones and the Great Circle game resources and guides.',
      images: [
        {
          url: `${siteUrl}/og-image.jpg`,
          width: 1200,
          height: 630,
          alt: 'Indiana Jones and the Great Circle Wiki',
        },
      ],
    },
    twitter: {
      ...
      title: 'About Indiana Jones and the Great Circle Wiki',
      description: 'Learn about our mission to provide the best Indiana Jones and the Great Circle game resources.',
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            About Indiana Jones and the Great Circle Wiki
          </h1>
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for Indiana Jones and the Great Circle
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Welcome to Indiana Jones and the Great Circle Wiki</h2>
            <p>
              Indiana Jones and the Great Circle Wiki is an <strong>unofficial, fan-made resource website</strong> dedicated to helping players
              master the action-adventure game "Indiana Jones and the Great Circle". We are a community-driven platform that provides comprehensive guides,
            ...
            <p>
              ...
              Indiana Jones and the Great Circle Wiki is here to support you every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower Indiana Jones and the Great Circle players with accurate, up-to-date information
            ...
            <h2>Our Vision</h2>
            <p>
              We envision Indiana Jones and the Great Circle Wiki as the <strong>go-to destination</strong> for every Indiana Jones and the Great Circle player seeking
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Indiana Jones and the Great Circle Wiki is built <strong>by the community, for the community</strong>. We welcome contributions,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Indiana Jones and the Great Circle Wiki is maintained by a dedicated team of passionate gamers and developers who love
              Indiana Jones and the Great Circle as much as you do. We're players first, constantly testing strategies, exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of Indiana Jones and the Great Circle mechanics and strategies</li>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              <strong>Indiana Jones and the Great Circle Wiki is an unofficial fan-made website.</strong> We are NOT affiliated with,
              endorsed by, or associated with the developers of Indiana Jones and the Great Circle or any official entities.
            </p>
            <p>
            ...
            <p>
              Indiana Jones and the Great Circle Wiki is a non-profit, community resource created by fans, for fans.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@indianajonesandthegreatcircle.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@indianajonesandthegreatcircle.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@indianajonesandthegreatcircle.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@indianajonesandthegreatcircle.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@indianajonesandthegreatcircle.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@indianajonesandthegreatcircle.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@indianajonesandthegreatcircle.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@indianajonesandthegreatcircle.wiki
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest guides, tips, and Indiana Jones and the Great Circle news.
